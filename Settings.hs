...
-- declared in the webproxy-yesod.hs file.
module Settings
    ( hamletFile
    , cassiusFile
    , juliusFile
...
-- See config/WebProxy.hs for command line arguments
...
--
-- If you change the resource pattern for StaticR in webproxy-yesod.hs, you will
-- have to make a corresponding change here.
--
-- To see how this value is used, see urlRenderOverride in webproxy-yesod.hs
